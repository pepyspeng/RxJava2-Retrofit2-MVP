...
import com.mvpdemo.utils.DisplayUtil;


/**
 * Created by zhupp on 2017/12/6.
 */
public class BookPageView extends View {
    ...
    private Paint pathCPaint;//绘制C区域内容画笔
    ...
    private void init(Context context, AttributeSet attrs) {
        defaultWidth = DisplayUtil.getScreenWidth();
        defaultHeight = DisplayUtil.getScreenHeight();
